from src.run_maddpg import run_maddpg
import wandb
...
def parse_arg():
    ...
    parser.add_argument('--alg', default='MADDPG', type=str, help='do not change only for wandb task classification')
    #Training args
    ...
    parser.add_argument('--nb-rpos', default=6, type=int, help='number of real pos')
    ...
    parser.add_argument('--discrete', default=True, type=bool, help='use discrete action')
...
run_maddpg(run.config,run)

#run_maddpg(args.__dict__,None)