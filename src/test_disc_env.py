...
class disc_naive_policy(object):
...
env = MultiCarSim('./scenario/scenario_train.yaml', step_t = 0.3,sim_step = 10,discrete=[1,1] )
env.global_agent_prop.N_laser = 4
env.global_agent_prop.true_N = 4
env.time_limit = 50.0
env.agent_number = 4

policy = disc_naive_policy(env.global_agent_prop.K_phi, env.global_agent_prop.L_axis, env.global_agent_prop.R_reach,env.action_decoder.encode)
